...
import { FilterTypes } from '../data/types';
...
const DeleteAllButton = ({onClick, render,activeFilter}:IProps)=>{
    ...
    return(
    <div className='flex flex-row p-2 w-2/5 h-12 cursor-pointer' onMouseEnter={onBeginHover} onMouseLeave={onStopHover} onClick={onClick}>
